...
import { ref } from "vue";
import { fatherFormRules } from "./utils/rule";
import { FatherProps } from "./utils/types";

const props = withDefaults(defineProps<FatherProps>(), {
  formInFather: () => ({
    id: "",
    organizationName: "",
    location: "",
...
const newFormInline = ref(props.formInFather);
